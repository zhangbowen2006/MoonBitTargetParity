...
更新：2026-09-26。此仓库是对初次驳回后更换选题的新项目；0.5.0 已通过远程四目标 CI 并发布到 Mooncakes。
...
| CI/构建/测试 | [Actions 36220634863](https://github.com/zhangbowen2006/MoonBitTargetParity/actions/runs/36220634863) 对 0.5.0 执行严格检查、全目标构建/测试、格式、接口快照、CLI、真实矩阵和包检查并成功；本地 29/29 测试通过 | 评审对选题价值仍需官方判断 |
