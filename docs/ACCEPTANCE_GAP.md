...
更新：2026-09-24。此仓库是对初次驳回后更换选题的新项目；公开仓库、远程 CI 和 Mooncakes 0.1.0 发布均已完成。
...
| Mooncakes | 0.1.0 已正式发布；公开 manifest build_status=success、has_package=true | 发布证据已完成；README/申报记录补丁正在更新为 0.1.1 |
