...
项目当前本地 MoonBit 测试为 12/12；Windows 本机 wasm、wasm-gc、js 实际探针对照通过。首个公开提交 `045b926` 的 [远程 CI](https://github.com/zhangbowen2006/MoonBitTargetParity/actions/runs/35986962761) 已在 Ubuntu 完成四目标验证。Mooncakes 发布仍以正式执行和 manifest 核验为准。
