...
项目当前本地 MoonBit 测试为 19/19；Windows 本机 wasm、wasm-gc、js 实际探针对照通过。0.3.0 诊断功能的公开 [远程 CI](https://github.com/zhangbowen2006/MoonBitTargetParity/actions/runs/35993578803) 已在 Ubuntu 完成四目标验证。Mooncakes [0.3.0 已正式发布](https://mooncakes.io/docs/zhangbowen2006/moonbit-target-parity)，manifest 核验结果记在 `docs/PUBLISHING.md`。
